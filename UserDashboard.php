...
body {
    ...
    background-image: url(./Resoruces/css-pattern-by-magicpattern.png);
}
    ...
    <div class="container dashboard-container">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Check all your bookings and details.</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Make a new booking with us.</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Cancel Bookings</h5>
                        <p class="card-text">Cancel your existing bookings.</p>
                        <a href="./cancel1.php" class="btn btn-custom">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
