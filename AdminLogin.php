...
<?php
	...
	if (isset($_POST['submit'])) //without select SQL
	{
		...
		echo "val=".$_POST['psw'];
		$sql="SELECT * FROM login WHERE username='admin' AND password='admin@123'";	//with select SQL
...
<body>
  ...
  <div class="col login-form-container">
    <form action="./AdminLogin.php" method="post">   <!--change once backend incorporated -->
